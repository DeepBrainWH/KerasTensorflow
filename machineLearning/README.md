...
- 在**监督学习**中，模型的**泛化误差**可**分解**为偏差、方差与噪声之和。
  <div align="center"><img src="https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/tree/master/_assets/TIM截图20180817204652.png" height="" /></div>

- **偏差**用于描述模型的**拟合能力**；<br/>
  **方差**用于描述模型的**稳定性**。
  <div align="center"><img src="https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/tree/master/_assets/TIM截图20180817192259.png" height="" /></div>
...
### 偏差与方差的计算公式
- 记在**训练集 D** 上学得的模型为
  <div align="center"><a href="http://www.codecogs.com/eqnedit.php?latex=f(\boldsymbol{x};D)"><img src="https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/tree/master/_assets/_assets/公式_20180817211749.png" height="" /></a></div>
...
- **偏差**（Bias）
  <div align="center"><a href="http://www.codecogs.com/eqnedit.php?latex=\large&space;bias^2(\boldsymbol{x})=(\hat{f}(\boldsymbol{x})-y)^2"><img src="https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/tree/master/_assets/_assets/公式_20180817210106.png" height="" /></a></div>
...
<!-- - **噪声**
  <div align="center"><a href="http://www.codecogs.com/eqnedit.php?latex=\large&space;var(\boldsymbol{x})=\mathbb{E}_D\left&space;[&space;\left&space;(&space;f(\boldsymbol{x};D)-\hat{f}(\boldsymbol{x})&space;\right&space;)^2&space;\right&space;]"><img src="https://github.com/imhuay/Algorithm_Interview_Notes-Chinese/tree/master/_assets/_assets/公式_20180817212111.png" height="" /></a></div> -->
